...
<head>
    ...
    ***************************************
    ...
    <style>
 .watermark{
  // background-image: url('<?php echo Kohana::$base_url; ?>images/logo.png');  
  repeat: no-repeat;
  opacity: 10;
  position: relative;
  bottom: 0;
...
<body class="watermark">  
    ...
    <div id="login">
    	...
    	<!-- Put your logo here -->
    	<div id="logo">
        	<img alt="iTalkGlobal" src="<?php echo Kohana::$base_url; ?>images/logo.png" >
        </div>
		<!-- The main part -->                   
		<?php echo $content;?>
        ...
        <footer id="footer">
        	Copyright &copy; 2013 Vigatel LLC
        </footer> 
    </div><!-- End "#login" -->        
</body>
</html>